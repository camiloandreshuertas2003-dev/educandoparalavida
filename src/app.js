...
// Endpoints del estado y gestión del Código QR de WhatsApp Web
...
app.post('/api/admin/qr-logout', async (req, res) => {
  try {
    const { logoutWhatsAppWeb } = require('./services/whatsappWebService');
